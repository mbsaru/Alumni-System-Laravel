            ...
            <div class="row">
                <div class="col-lg-6 col-sm-7 col-7">
                    <div class="preheader-left">
                        <a href="mailto:info@dekut.ac.ke"><strong>Email:</strong>chmsu@gmail.com</a>
                ...
                <div class="col-lg-6 col-sm-5 col-5 text-right">
                    <div class="preheader-right">
                        ...
                        <a title="Student login" class="btn-auth btn-auth-rev bg-danger" href="/login/student">Student</a>
                    ...
                    <div class="single-widget-wrap">
                        <div class="widgei-body">
                            <div class="footer-about">
                                ...
                                <p>Contact Info</p>
                                <a href="#">Phone: 09123456892</a> <a href="#">Telephone: 007-8000</a> <br> <a href="#">Email: chmsualumni@gmail.com</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="footer-bottom-text">
                        <p>© 2022 CHMSU ALUMNI SYSTEM, All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
